<?php
	...
	$result["rx"] = $db -> query("select distinct b.F_node_id from [Things+].[dbo].[TB_Share_Model] a,[Things+].[dbo].[TB_Share_GroupToNode] b where a.F_id like '%flex%' and a.F_name like '%'+b.F_group_id+'%' and a.F_app = ".$app." and b.F_node_id not in ('".implode("','",$qz)."')");
	ob_clean();
