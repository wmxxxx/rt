...
(function($) {
	...
	$.Poshytip.prototype = {
		...
		calcPos: function() {
			...
			if (this.opts.alignTo == 'cursor') {
				xL = xC = xR = this.eventX>0?this.eventX:0;
				yT = yC = yB = this.eventY>0?this.eventY:0;
				...
				case 'inner-left':
					...
					if (pos.l + this.tipOuterW > win.l + win.w)
				    {
						if(this.opts.alignTo == 'cursor')
						{
							...
							pos.l = this.eventX - this.tipOuterW-this.opts.offsetX;
							pos.t = this.eventY;
							pos.arrow = 'right';
							break;
						}
						...
						{
							pos.l = this.opts.offsetX - this.tipOuterW-20;
							this.opts.offsetY=this.opts.offsetY-this.tipOuterH;
							pos.arrow = 'right';
						}
					}
			...
			switch (this.opts.alignY) {
				...
				default: // 'top' || 'inner-bottom'
					if (this.opts.alignTo == 'cursor' && 
						(pos.arrow=='right' || pos.arrow=='left'))
					{
