MainPanel = function (container) {
    return {
        init: function () {
            ...
            if (sys_type == 1) {
                $('#centerPanel').html('<iframe id="mdframe" width="100%" height="100%" marginwidth="0" marginheight="0" frameborder="0" src="/Lib/mdeditor/index.html?s_tag=' + TUI.env.sys.tag + '&f_type=help"></iframe>');
